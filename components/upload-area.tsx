...
export function UploadArea({ 
  ...
  return (
    <div 
      {...getRootProps()} 
      className={`
        border border-dashed rounded-md p-8 text-center transition-all duration-300 cursor-pointer
        ${isDragActive 
          ? 'border-primary bg-primary/10 shadow-lg -translate-y-2' 
          : 'border-border hover:border-primary/60 hover:bg-muted/30 shadow-md hover:shadow-lg hover:-translate-y-1'
        }
    ...
    >
      ...
      <div className="space-y-6">
        <div className="w-20 h-20 mx-auto rounded-full bg-primary/5 flex items-center justify-center relative border border-primary/20 shadow-sm">
          {loading ? (
